...
<DropDownPicker 
    style= {{width:wp('90%'), marginTop:20, borderBottomWidth:.5, alignSelf:'center', borderWidth: 0 , backgroundColor:'#ededed'}}
      open={open}
...
<DropDownPicker 
    style= {{width:wp('90%'), marginTop:10, borderBottomWidth:.5, alignSelf:'center', borderWidth: 0 , backgroundColor:'#ededed'}}
      open={open}
      disableBorderRadius={true}
       value={value}
      items={items}
